<template>
    <header class="header fixed top-0 w-full transition-all lg:pt-8" :class="isScrolled ? 'header-scrolled lg:pt-0' : 'lg:pt-8'">
    ...
    <Transition name="menu">
        <HiddenMenu v-if="isOpen" @closeMenu="toggleMenu"></HiddenMenu>
    </Transition>
</template>
